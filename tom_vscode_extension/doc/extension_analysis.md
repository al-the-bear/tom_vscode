...
| Logs | `output` | Active quest's log files — ten sub-tabs (MD Trail, Trail, Prompts, Answers, Progress, Overview, Notes, Refresh, DocUpdate, Deferred) via `questLogs-handler.ts` |
