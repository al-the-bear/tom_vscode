...
- [copilot_chat_tools.md](copilot_chat_tools.md) — Copilot and Ask-AI tooling reference (merged).

## YAML Graph Editor

- [yaml_graph.md](yaml_graph.md) — current behavior and usage.
- [yaml_graph_architecture_design.md](yaml_graph_architecture_design.md) — implementation architecture.
...
- [reusable_component_analysis.md](reusable_component_analysis.md) — reusable webview/UI component inventory.
