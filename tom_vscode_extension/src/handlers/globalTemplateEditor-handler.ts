    ...
    switch (category) {
        ...
        case 'anthropicProfiles': {
            ...
            fields.push(
                ...
                { name: 'useBuiltInTools', label: 'Use Built-In Agent SDK Tools', type: 'checkbox', value: String(p.useBuiltInTools === true), help: 'Agent SDK transport only: expose Claude Code\'s built-in tool preset (Read, Write, Edit, Glob, Grep, Bash, WebFetch, WebSearch, TaskCreate/TaskUpdate, …) and automatically suppress extension tools that duplicate them. No effect on the direct Anthropic SDK.' },
