...
<div class="add-form" id="addForm">
  ...
  <div class="entry-sections">
    ...
    <div class="entry-section fill">
      <label>Repeat Prefix (supports {{repeatNumber}} / \${repeatNumber}, {{repeatIndex}} / \${repeatIndex}, {{repeatCount}} / \${repeatCount})</label>
      <textarea id="addRepeatPrefix" rows="2" placeholder="Optional text inserted before repeated prompt body"></textarea>
      <label>Repeat Suffix (supports {{repeatNumber}} / \${repeatNumber}, {{repeatIndex}} / \${repeatIndex}, {{repeatCount}} / \${repeatCount})</label>
