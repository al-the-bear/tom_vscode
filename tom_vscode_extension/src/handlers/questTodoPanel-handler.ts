...
/** CSS + HTML fragment re-exported from the extracted assets module.
 *  getQuestTodoScript stays in-handler because its 1,800-line template
 *  literal wires into the webview state contract. */
