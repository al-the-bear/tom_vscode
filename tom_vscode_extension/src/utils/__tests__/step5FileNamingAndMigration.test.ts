...
describe('Step 5 - Issue 1 queue/timed filename strategy', () => {
    ...
    test('buildQueueEntryFileName prefixes hostname and workspace', () => {
        ...
        assert.equal(fileName, 'dev-box_tom_agent_container_260326_140506_vscode_extension.prompt.entry.queue.yaml');
    });
