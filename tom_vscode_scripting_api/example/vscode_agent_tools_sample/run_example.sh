...
#   ./run_example.sh workspace_metadata       # run a single concept by name
#   ./run_example.sh send_to_chat             # run the interactive concept
#   ./run_example.sh todos 127.0.0.1          # override the bridge host
#
