...
#   ./run_example.sh options             # run a single concept by name
#   ./run_example.sh streaming_query     # run the interactive live concept
#   ./run_example.sh options 127.0.0.1   # override the bridge host
#
