# Run a Tom Agent SDK example.
#
#   ./run_example.ps1                     # run all examples (the aggregator)
#   ./run_example.ps1 options             # run a single concept by name
#   ./run_example.ps1 streaming_query     # run the interactive live concept
#   ./run_example.ps1 options 127.0.0.1   # override the bridge host
#
