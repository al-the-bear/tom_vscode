...
#   ./run_example.sh file_batch            # run a single concept by name
#   ./run_example.sh quick_pick_input      # run the interactive concept
#   ./run_example.sh editor_edits 127.0.0.1  # override the bridge host
#
