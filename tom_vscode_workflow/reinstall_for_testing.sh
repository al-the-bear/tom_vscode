...
# Development reinstall script for tom_vscode_workflow extension
...
echo "🔧 Reinstalling tom_vscode_workflow for testing..."
...
"$CODE_CLI" --uninstall-extension tom.tom-vscode-workflow 2>/dev/null || true
...
$VSCE_CMD package --allow-missing-repository --skip-license --baseContentUrl https://github.com/al-the-bear/tom/blob/main/tom_vscode_workflow
