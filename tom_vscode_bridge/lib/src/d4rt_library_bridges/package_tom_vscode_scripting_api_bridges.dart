...
// Sources: 13 files
// Generated: 2026-02-03T20:15:08.452123
...
import 'package:tom_vscode_scripting_api/tom_vscode_scripting_api.dart' as $pkg;
...
BridgedClass _createVsCodeHelperBridge() {
  return BridgedClass(
    ...
    staticMethodSignatures: {
      ...
      'askCopilotChat': 'Future<Map<String, String>> askCopilotChat(String prompt, {String? requestId, int pollIntervalSeconds = 10, int timeoutSeconds = 7200, bool customResponseInstructions = false})',
